...
def generate_launch_description():
    ...
    gazebo_models_path, ignore_last_dir = os.path.split(pkg_gnc)
    ...
    world_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_gnc, 'launch', 'world.launch.py'),
        ),
        launch_arguments={
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([pkg_gnc, 'rviz', LaunchConfiguration('rviz_config')])],
